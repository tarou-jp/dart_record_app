...
<head>
  ...
  <link rel="stylesheet" href="http://turkey.slis.tsukuba.ac.jp/~s2210573/signin1.css">
</head>
...
<body>
  ...
  if (isset($_GET["is_final"])) {
    ...
    header('Location: http://turkey.slis.tsukuba.ac.jp/~s2210573/resist_cre.php?gameId=' . $gameId . '&round_num=' . $round_num);
    exit();
  }
